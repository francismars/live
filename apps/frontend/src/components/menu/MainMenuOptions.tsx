...
const MainMenuOptions: React.FC<MainMenuOptionsProps> = ({ onPlay, onWatch, hide }) => (
  <div
  ...
  >
    ...
    <button className="px-8 py-3 text-lg font-semibold bg-white text-black rounded-full shadow hover:bg-gray-200 transition" onClick={onWatch}>Watch</button>
