...
const ChatButton: React.FC = () => (
  <button className="absolute bottom-8 right-12 w-14 h-14 rounded-full bg-white text-black flex items-center justify-center shadow-lg hover:bg-gray-200 transition z-20">
